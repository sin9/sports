...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" id="main" >
    <!-- 内容主体区域 -->
    	...
    	<table class="layui-table" lay-data="{width: 892, height:400, page:true, id:'idTest'}" lay-filter="demo" >
    		<thead>
    			<tr>
    				...
    				<th lay-data="{field:'score', width:80, sort: true, fixed: 'right'}">邮箱</th>
    		...
    		<a class="layui-btn layui-btn-danger layui-btn-xs" href="/deleteuser/${key.uid}">删除</a>
                             </td>
							<td></td>
                   </tr>
